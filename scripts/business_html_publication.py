...
<section class="page"><p class="eyebrow">信息图</p><h2>一个 RD 整体承压，由三个问题品类和两个关键 Hub 拉动。</h2><div class="infographic"><div class="big-num"><b>{html.escape(issue_count[:1] or '3')}</b><span>问题品类</span></div><div class="flow"><div>门店层</div><div>Hub层</div><div>品类层</div><div>RD整体</div></div><div class="big-num red"><b>2</b><span>优先Hub：观山湖、凯里</span></div><div class="mini-map"><span>凯里零销售</span><span>观山湖执行不足</span><span>兴义局部压力</span><span>遵义经验可复制</span></div></div><p class="source-note">图 0：基于源报告“反向归因链总结”重绘。</p><footer class="folio"><span>YANGFAN BUSINESS DIAGNOSIS</span><span>执行摘要</span><span>06</span></footer></section>
...
<section class="page"><p class="fig-label">图 4</p><h2>P0 动作应先恢复确定性缺口，再处理区域竞争和经验复制。</h2><div class="timeline">{action_cards}</div><p class="source-note">来源：源 HTML 行动优先级矩阵。</p><footer class="folio"><span>YANGFAN BUSINESS DIAGNOSIS</span><span>核心图表</span><span>10</span></footer></section>
...
<section class="page"><p class="fig-label">表 1</p><h2>RD 整体 IYA 为 {html.escape(rd_iya)}，属于承压但未失速状态。</h2>{_html_table(kpi)}<p class="source-note">来源：源 HTML RD整体KPI。</p><footer class="folio"><span>YANGFAN BUSINESS DIAGNOSIS</span><span>分销商概况</span><span>12</span></footer></section>
<section class="page"><p class="fig-label">表 2</p><h2>三类问题品类低于阈值，健康品类提供对冲。</h2>{_html_table(category)}<p class="source-note">来源：源 HTML 品类结构分布。</p><footer class="folio"><span>YANGFAN BUSINESS DIAGNOSIS</span><span>品类概况</span><span>13</span></footer></section>
...
<section class="page"><p class="eyebrow">门店层诊断</p><h2>观山湖缺口没有集中到少数问题门店，凯里则呈现全品类执行断点。</h2><div class="metric-row"><div><b>3/3</b><span>观山湖问题品类查询未返回集中异常</span></div><div><b>0.000</b><span>凯里多品类零销售表现</span></div><div><b>2.453</b><span>遵义 Hair IYA 正向对照</span></div><div><b>0.226</b><span>兴义 Fabric 局部断崖</span></div></div><p class="source-note">来源：源 HTML 门店层查询结果与 Hub x Category IYA 表；本页为证据解释，不新增业务口径。</p><footer class="folio"><span>YANGFAN BUSINESS DIAGNOSIS</span><span>Hub归因</span><span>17</span></footer></section>
<section class="page"><p class="fig-label">表 4</p><h2>行动计划应先处理 P0 确定性断点，再扩展到经验复制。</h2>{_html_table(action[:6])}<p class="source-note">来源：源 HTML 综合行动计划。</p><footer class="folio"><span>YANGFAN BUSINESS DIAGNOSIS</span><span>行动计划</span><span>18</span></footer></section>
<section class="page"><p class="eyebrow">方法与口径</p><h2>图表重绘保留源指标口径，视觉表达服务于阅读，不改变业务定义。</h2>{_html_table(method)}<p class="source-note">来源：源 HTML 数据口径说明。</p><footer class="folio"><span>YANGFAN BUSINESS DIAGNOSIS</span><span>方法</span><span>19</span></footer></section>
<section class="page"><p class="eyebrow">参考与附录</p><h2>参考资料</h2><ol><li>{html.escape(title)} 源 HTML。</li><li>源报告 RD整体KPI、品类结构分布、Hub层分析、门店层查询结果、综合行动计划。</li><li>图表说明：本报告图表基于源表重新绘制；IYA、YoY、阈值等定义沿用源报告口径。</li></ol><footer class="folio"><span>YANGFAN BUSINESS DIAGNOSIS</span><span>参考资料</span><span>20</span></footer></section>
</body></html>"""
    meta = {
        "title": title,
        "source": source_label,
